<!DOCTYPE html>
  ...
  <div class="container-fluid">
	...
	<li><a href="login.php">Expendetur</a></li>
      <li class="active"><a href="Home.php">Sales</a></li>
	  <li><a href="input.php">Exit</a></li>
...
<div class="btn-group" id = "buttonTest">
  ...
  <div class="panel-heading"><h1> Sales Transaction </h1></div>
...
<div class="footer-bottom">
  ...
  <script src="https://www.amcharts.com/lib/3/amcharts.js"></script>
	...
	<script type="text/javascript" src="js/chartSales.js"></script>
